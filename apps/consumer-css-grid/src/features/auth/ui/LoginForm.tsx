      ...
      <div className={styles.container}>
        ...
        {authNoticeMessage ? (
          <div
            ...
            role="status"
            aria-live="polite"
            data-testid="consumer-css-grid-login-auth-notice"
          >
        ...
        <div className={styles.card}>
          <form className={styles.form} onSubmit={handleSubmit} data-testid="consumer-css-grid-login-form" noValidate>
            <div>
              ...
              <input
                ...
                data-testid="consumer-css-grid-login-email"
              />
              {fieldErrors.email ? (
            ...
            <div>
              ...
              <div className={styles.passwordWrap}>
                <input
                  ...
                  data-testid="consumer-css-grid-login-password"
                />
                <button
                  type="button"
            ...
            {errorMessage ? (
              <div className={styles.errorBanner} role="alert" data-testid="consumer-css-grid-login-error">
            ...
            <button
              ...
              data-testid="consumer-css-grid-login-submit"
            >
              {loading ? (
            ...
            {googleStartUrl ? (
              <>
                ...
                <button
                  ...
                  data-testid="consumer-css-grid-login-google"
                >
        ...
        <p className={styles.footer}>
          ...
          <Link
            ...
            data-testid="consumer-css-grid-login-signup-link"
          >
            Sign up
          </Link>
        </p>
