...
export function ManualCardForm({
  ...
  return (
    <div className="grid gap-4">
      <div className="rounded-3xl border border-(--app-border) bg-(--app-surface-muted) px-4 py-4 text-sm leading-6 text-(--app-text-soft)">
      ...
      <div>
        <label className="mb-2 block text-sm text-(--app-text-muted)" htmlFor="card-brand">
          Card brand
        </label>
        <input
          id="card-brand"
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
        <div>
          <label className="mb-2 block text-sm text-(--app-text-muted)" htmlFor="card-last4">
            Last 4
          </label>
          <input
            id="card-last4"
        ...
        <div>
          <label className="mb-2 block text-sm text-(--app-text-muted)" htmlFor="card-exp-month">
            Exp. month
          </label>
          <input
            id="card-exp-month"
        ...
        <div>
          <label className="mb-2 block text-sm text-(--app-text-muted)" htmlFor="card-exp-year">
            Exp. year
          </label>
          <input
            id="card-exp-year"
      ...
      />
      <div>
        <label className="mb-2 block text-sm text-(--app-text-muted)" htmlFor="card-billing-name">
          Billing name
        </label>
        <input
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        ...
        <div>
          <label className="mb-2 block text-sm text-(--app-text-muted)" htmlFor="card-billing-phone">
            Billing phone
          </label>
          <input
      ...
      <label className="flex items-center gap-3 text-sm text-(--app-text-soft)">
        <input
          type="checkbox"
