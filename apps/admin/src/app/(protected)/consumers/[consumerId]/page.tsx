...
export default function ConsumerDetailsPage(props: { params: Promise<{ consumerId: string }> }) {
  ...
  useEffect(() => {
    ...
    props.params.then((params) => getConsumer(params.consumerId)).then(setConsumer);
  }, [props]);
