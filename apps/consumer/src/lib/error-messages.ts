...
const MESSAGE_MAP: Record<string, string> = {
  ...
  [errorCodes.IDEMPOTENCY_KEY_REQUIRED_PAY_WITH_SAVED_METHOD]: `A request id is required to pay with a saved payment method. Please refresh the page and try again.`,
