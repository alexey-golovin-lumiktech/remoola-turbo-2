  ...
  if (compactChrome) {
    return (
      <details className="lg:hidden">
        <summary className="list-none rounded-card border border-white/8 bg-linear-to-br from-white/4 to-white/2 px-4 py-3 text-sm text-white/80 shadow-[0_12px_30px_rgba(2,6,23,0.14)]">
