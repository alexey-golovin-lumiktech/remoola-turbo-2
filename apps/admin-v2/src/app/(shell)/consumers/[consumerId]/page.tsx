...
const nestedCardClass = nestedPanelClass;
  ...
  return (
    ...
    >
      <>
        ...
        >
          <p className="muted">
            Consumer case summary for review, identity status, support actions, and cross-links into verification,
            audit, payment methods, and recent payment activity.
          </p>
          <div className="pillRow">
            <StatusPill status={consumer.verificationStatus} />
            <span className="pill">{consumer.accountType}</span>
        ...
        <section className="detailGrid">
          ...
          >
            <div className={operatorFormClass}>
              {canSuspend ? (
                <form action={suspendConsumerAction.bind(null, consumer.id)} className={operatorFormClass}>
                  ...
                  <div className={operatorFormFieldsClass}>
                    <label className="field">
                      ...
                      <textarea
                        name="content"
                        required
                        placeholder="Investigation note, escalation context, next step..."
                      />
                    </label>
                  </div>
                  <div className={operatorFormActionsClass}>
