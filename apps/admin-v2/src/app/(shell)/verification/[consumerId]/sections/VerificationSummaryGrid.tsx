  ...
  return (
    <section className="statsGrid">
      <Panel>
        ...
        <p className={mutedTextClass}>Verification updated: {formatDateTime(verificationCase.verificationUpdatedAt)}</p>
      ...
      <Panel>
        ...
        <p className={mutedTextClass}>
          SLA computed: {formatDateTime(verificationCase.verificationSla.lastComputedAt)}
        </p>
      </Panel>
      <Panel>
