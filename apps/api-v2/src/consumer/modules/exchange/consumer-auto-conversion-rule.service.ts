...
@Injectable()
export class ConsumerAutoConversionRuleService {
  private readonly logger = new Logger(ConsumerAutoConversionRuleService.name);
  ...
  async executeAutoConversionRule(
    rule: {
      id: string;
      consumerId: string;
