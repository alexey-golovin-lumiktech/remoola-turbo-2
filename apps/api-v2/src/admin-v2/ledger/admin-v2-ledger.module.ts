...
@Module({
  ...
  providers: [AdminV2LedgerService, AdminV2LedgerAnomaliesQuery, AdminV2LedgerAnomaliesService],
  exports: [AdminV2LedgerService, AdminV2LedgerAnomaliesQuery, AdminV2LedgerAnomaliesService],
})
