export function SkeletonCard() {
  return (
    ...
    >
      ...
      <div className={`mt-2 ` + `h-6 ` + `w-1/2 ` + `rounded ` + `bg-slate-200 dark:bg-slate-700`} />
    </div>
  );
}
...
export function SkeletonStat() {
  return (
    ...
    >
      ...
      <div className={`mt-2 ` + `h-7 ` + `w-24 ` + `rounded ` + `bg-slate-200 dark:bg-slate-700`} />
    </div>
  );
}
...
export function SkeletonText({ className }: { className?: string }) {
  return (
    <div
      className={`animate-pulse ` + `rounded ` + `bg-slate-200 dark:bg-slate-700 ` + `${className ?? `h-4 w-full`}`}
    />
  );
}
