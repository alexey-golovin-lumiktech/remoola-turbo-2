...
const MESSAGE_MAP: Record<string, string> = {
  ...
  [errorCodes.INVALID_LEDGER_STATE_EMAIL_PAYMENT_SEND]: `This payment request is in an unexpected state and can't be sent. Please refresh the app and try again or contact support.`,
  [errorCodes.INVALID_LEDGER_STATE_DRAFT]: `This draft payment request is in an unexpected state. Please refresh the app and try again or contact support.`,
  ...
  [errorCodes.IDEMPOTENCY_KEY_REQUIRED_WITHDRAW]: `A request id is required for withdrawals. Please refresh the app and try again.`,
  [errorCodes.IDEMPOTENCY_KEY_REQUIRED_TRANSFER]: `A request id is required for transfers. Please refresh the app and try again.`,
  ...
  [errorCodes.CONSUMER_NOT_FOUND_CHANGE_PASSWORD]: `This password reset link has expired or is invalid. Request a new link from the forgot password screen.`,
  [errorCodes.CHANGE_PASSWORD_FLOW_EXPIRED]: `This password reset link has expired or is invalid. Request a new link from the forgot password screen.`,
  ...
  [errorCodes.MISSING_GOOGLE_NONCE]: `Your sign-in session is invalid or expired. Please start the Google sign-in again from the sign-in screen.`,
  [errorCodes.INVALID_GOOGLE_NONCE]: `Your sign-in session doesn't match. Please start the Google sign-in again from the sign-in screen.`,
  ...
  [errorCodes.MISSING_EXCHANGE_TOKEN]: `The sign-in link is missing. Please complete sign-in from the sign-in screen.`,
  ...
  [errorCodes.RATE_STALE]: `The exchange rate has expired. Please refresh the app to get the latest rate.`,
  ...
  [errorCodes.INVALID_LEDGER_STATE_EMAIL_PAYMENT_STRIPE]: `This payment is in an unexpected state for card payment. Please refresh the app and try again or contact support.`,
  ...
  [errorCodes.STRIPE_NO_CLIENT_SECRET]: `We couldn't start the payment setup. Please try again; if it keeps failing, contact support.`,
...
const LOCAL_TOAST_MESSAGE_MAP: Record<string, string> = {
  ...
  [localToastKeys.DOCUMENTS_DELETE_FAILED]: `We couldn't delete the selected documents. Please try again; if it keeps failing, refresh the app.`,
  ...
  [localToastKeys.PAYMENT_CONTINUE_FAILED]: `We couldn't complete this step. Refresh the app and try again, or pick up where you left off from your payment list.`,

  // Settings / profile – load or save failed
  [localToastKeys.PROFILE_LOAD_FAILED]: `We couldn't load your profile. Refresh the app to try again.`,
  [localToastKeys.PROFILE_UPDATE_FAILED]: `We couldn't save your profile changes. Please try again; if it keeps failing, refresh the app and re-enter your details.`,
  ...
  [localToastKeys.RULE_DELETE_FAILED]: `We couldn't delete this rule. Please try again or refresh the app.`,
  ...
  [localToastKeys.SCHEDULED_CONVERSION_CANCEL_FAILED]: `We couldn't cancel this scheduled conversion. Please try again or refresh the app.`,
  ...
  // Misc
  [localToastKeys.CLIPBOARD_ERROR]: `Failed to copy. Please copy manually.`,
