...
export const getInvoiceNumberDateTable = (invoice: Invoice): string => {
  return numberDateTemplate.replace(/{{invoiceNumber}}/g, invoice.number.toString()).replace(/{{invoiceDate}}/g, invoice.date.toString())
}
