...
export class TransactionController {
  ...
  getConsumerBallance(@ReqAuthIdentity() consumer: IConsumerModel): Promise<CONSUMER.GetConsumerBallanceResult[]> {
    return this.service.getConsumerBallance({ consumerId: consumer.id })
  }
