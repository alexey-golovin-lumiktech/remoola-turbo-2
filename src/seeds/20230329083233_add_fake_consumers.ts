...
export async function seed(knex: Knex): Promise<void> {
  ...
  const raw = [
    { firstName: `simplelogin`, lastName: `newsletter`, email: `simplelogin-newsletter.djakm@simplelogin.com`, password: `T2?cL6^dF4@o` },
    { firstName: `alexey`, lastName: `golovin`, email: `alexey.golovin@lumiktech.com`, password: `Wirebill@Admin123!` },
    { firstName: `purelybroom`, lastName: `866`, email: `purelybroom866@simplelogin.com`, password: `E6^gR6?uD7!x` },
  ]
  ...
  const consumersToInsert = raw.map(x => {
    ...
    return { firstName: x.firstName, lastName: x.lastName, email: x.email, password: hash, salt: salt, verified: true }
  })
