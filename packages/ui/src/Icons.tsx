...
/**
 * Alert triangle icon for errors and warnings
 */
 ...
 * Information icon
 */
export function InformationCircleIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
 ...
 */
export function QuestionMarkCircleIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * Lock icon for security/passwords
 */
...
/**
 * Landmark/bank building icon for bank accounts
 */
...
/**
 * Star icon for favorites/default
 */
...
/**
 * File download icon for download actions
 */
export function FileDownIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
 ...
 */
export function DocumentTextIcon({ size = 24, className, strokeWidth = 2, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * Document list icon with bullet row
 */
export function DocumentListIcon({ size = 24, className, strokeWidth = 2, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * Payment card icon variant used in consumer navigation
 */
export function PaymentCardIcon({ size = 24, className, strokeWidth = 2, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
 ...
 * Folder icon
 */
export function FolderIcon({ size = 24, className, strokeWidth = 2, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
 ...
 * Bank building icon
 */
export function BankBuildingIcon({ size = 24, className, strokeWidth = 2, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * Transfer/withdraw icon
 */
export function TransferIcon({ size = 24, className, strokeWidth = 2, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
 ...
 */
export function ExchangeIcon({ size = 24, className, strokeWidth = 2, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * Gear settings icon variant
 */
export function SettingsGearIcon({ size = 24, className, strokeWidth = 2, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * Logout arrow icon variant
 */
export function LogoutLineIcon({ size = 24, className, strokeWidth = 2, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
 ...
 * Wallet icon
 */
export function WalletIcon({ size = 24, className, strokeWidth = 2, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
 ...
 * Clock icon
 */
export function ClockIcon({ size = 24, className, strokeWidth = 2, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
 ...
 */
export function PaperPlaneIcon({ size = 24, className, strokeWidth = 2, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
