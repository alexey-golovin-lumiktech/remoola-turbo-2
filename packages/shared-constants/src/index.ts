...
export const errorCodes = {
  ...
  CONSUMER_NO_PASSWORD_SET: `CONSUMER_NO_PASSWORD_SET`,
  ...
  // Stripe verify – profile required before starting verification
  PROFILE_INCOMPLETE_VERIFY: `PROFILE_INCOMPLETE_VERIFY`,
  ...
  IDEMPOTENCY_KEY_REQUIRED_PAY_WITH_SAVED_METHOD: `IDEMPOTENCY_KEY_REQUIRED_PAY_WITH_SAVED_METHOD`,
...
export const adminErrorCodes = {
  ...
  ADMIN_NO_IDENTITY_RECORD: `ADMIN_NO_IDENTITY_RECORD`,
  ADMIN_REFRESH_TOKEN_INVALID: `ADMIN_REFRESH_TOKEN_INVALID`,

  // Admin payment-requests — reversal
  ADMIN_PAYMENT_REQUEST_NOT_FOUND: `ADMIN_PAYMENT_REQUEST_NOT_FOUND`,
  ADMIN_ONLY_COMPLETED_CAN_BE_REVERSED: `ADMIN_ONLY_COMPLETED_CAN_BE_REVERSED`,
  ADMIN_INVALID_PAYMENT_AMOUNT: `ADMIN_INVALID_PAYMENT_AMOUNT`,
  ADMIN_INVALID_REVERSAL_AMOUNT: `ADMIN_INVALID_REVERSAL_AMOUNT`,
  ADMIN_PAYMENT_REQUEST_ALREADY_FULLY_REVERSED: `ADMIN_PAYMENT_REQUEST_ALREADY_FULLY_REVERSED`,
  ADMIN_REVERSAL_AMOUNT_EXCEEDS_REMAINING_BALANCE: `ADMIN_REVERSAL_AMOUNT_EXCEEDS_REMAINING_BALANCE`,
  ADMIN_STRIPE_PAYMENT_INTENT_NOT_FOUND_FOR_REFUND: `ADMIN_STRIPE_PAYMENT_INTENT_NOT_FOUND_FOR_REFUND`,

  // Admin admins controller
  ADMIN_ONLY_SUPER_CAN_CHANGE_PASSWORDS: `ADMIN_ONLY_SUPER_CAN_CHANGE_PASSWORDS`,
  ADMIN_ONLY_SUPER_CAN_UPDATE_ADMINS: `ADMIN_ONLY_SUPER_CAN_UPDATE_ADMINS`,
  ADMIN_UNSUPPORTED_ADMIN_ACTION: `ADMIN_UNSUPPORTED_ADMIN_ACTION`,
  ADMIN_CANNOT_DELETE_YOURSELF: `ADMIN_CANNOT_DELETE_YOURSELF`,
  ADMIN_ONLY_SUPER_CAN_RUN_MIGRATIONS: `ADMIN_ONLY_SUPER_CAN_RUN_MIGRATIONS`,
  ADMIN_ONLY_SUPER_CAN_VIEW_AUDIT: `ADMIN_ONLY_SUPER_CAN_VIEW_AUDIT`,

  // Step-up / re-auth for critical actions
  ADMIN_PASSWORD_CONFIRMATION_REQUIRED: `ADMIN_PASSWORD_CONFIRMATION_REQUIRED`,
  ADMIN_PASSWORD_CONFIRMATION_INVALID: `ADMIN_PASSWORD_CONFIRMATION_INVALID`,

  // Admin consumers — verification
  ADMIN_UNSUPPORTED_VERIFICATION_ACTION: `ADMIN_UNSUPPORTED_VERIFICATION_ACTION`,

  // Admin exchange — rates
  ADMIN_EXCHANGE_RATE_NOT_FOUND: `ADMIN_EXCHANGE_RATE_NOT_FOUND`,
  ADMIN_SOURCE_AND_TARGET_CURRENCIES_MUST_DIFFER: `ADMIN_SOURCE_AND_TARGET_CURRENCIES_MUST_DIFFER`,
  ADMIN_INVALID_EXCHANGE_RATE: `ADMIN_INVALID_EXCHANGE_RATE`,
  ADMIN_BID_RATE_CANNOT_EXCEED_ASK_RATE: `ADMIN_BID_RATE_CANNOT_EXCEED_ASK_RATE`,
  ADMIN_CONFIDENCE_MUST_BE_0_100: `ADMIN_CONFIDENCE_MUST_BE_0_100`,
  ADMIN_INVALID_EFFECTIVE_AT: `ADMIN_INVALID_EFFECTIVE_AT`,
  ADMIN_INVALID_EXPIRES_AT: `ADMIN_INVALID_EXPIRES_AT`,
  ADMIN_EXPIRES_AT_MUST_BE_AFTER_EFFECTIVE_AT: `ADMIN_EXPIRES_AT_MUST_BE_AFTER_EFFECTIVE_AT`,
  ADMIN_EFFECTIVE_AT_MUST_BE_UNIQUE_FOR_PAIR: `ADMIN_EFFECTIVE_AT_MUST_BE_UNIQUE_FOR_PAIR`,

  // Admin exchange — rules
  ADMIN_RULE_NOT_FOUND: `ADMIN_RULE_NOT_FOUND`,
  ADMIN_INVALID_TARGET_BALANCE: `ADMIN_INVALID_TARGET_BALANCE`,
  ADMIN_INVALID_MAX_CONVERT_AMOUNT: `ADMIN_INVALID_MAX_CONVERT_AMOUNT`,

  // Admin exchange — scheduled
  ADMIN_SCHEDULED_CONVERSION_NOT_FOUND: `ADMIN_SCHEDULED_CONVERSION_NOT_FOUND`,
  ADMIN_CONVERSION_ALREADY_EXECUTED: `ADMIN_CONVERSION_ALREADY_EXECUTED`,
  ADMIN_CONVERSION_ALREADY_CANCELLED: `ADMIN_CONVERSION_ALREADY_CANCELLED`,
} as const;
