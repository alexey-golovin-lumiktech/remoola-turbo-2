...
const ACCOUNT_TYPES = [ACCOUNT_TYPE.BUSINESS, ACCOUNT_TYPE.CONTRACTOR] as const;
...
const CONTRACTOR_KINDS = [CONTRACTOR_KIND.ENTITY, CONTRACTOR_KIND.INDIVIDUAL] as const;
...
const ORGANIZATION_SIZES = [ORGANIZATION_SIZE.SMALL, ORGANIZATION_SIZE.MEDIUM, ORGANIZATION_SIZE.LARGE] as const;
