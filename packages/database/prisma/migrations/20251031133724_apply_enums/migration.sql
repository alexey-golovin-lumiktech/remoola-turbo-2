...
*/
-- CreateEnum
CREATE TYPE "transaction_fees_type_enum" AS ENUM ('Fees Included', 'No Fees Included');
...
DROP COLUMN "type",
ADD COLUMN     "type" "transaction_type_enum" NOT NULL DEFAULT 'Credit Card';
...
ADD COLUMN     "action_type" "transaction_action_type_enum" NOT NULL,
DROP COLUMN "status",
ADD COLUMN     "status" "transaction_status_enum" NOT NULL,
DROP COLUMN "fees_type",
ADD COLUMN     "fees_type" "transaction_fees_type_enum" DEFAULT 'No Fees Included';

-- DropEnum
DROP TYPE "public"."fees_type_enum";
