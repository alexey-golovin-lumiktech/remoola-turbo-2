import { type InvoiceItemsItem, type InvoiceSummary } from '../../types'
...
const calculateSummary = (items: InvoiceItemsItem[]): InvoiceSummary =>
  items.reduce(
    (acc, next) => {
...
export const getInvoiceSummaryTable = (invoiceItems: InvoiceItemsItem[]): string => {
